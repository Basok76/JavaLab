...
public class Main {
    public static void main(String[] args) {
        ...
        for (int number : numbers) {
            ...
            // Проверка на все четные цифры и равенство четных и нечетных
            ...
            // Проверка на строгое возрастание цифр
            temp = number;
