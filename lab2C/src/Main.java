...
public class Main {
    ...
    public static int Four(int[][] matrix) {
        int sum = 0;
        for (int[] row : matrix) {
...
//    }
    ...
    private static int[][] Ten(int[][] matrix) {
        int n = matrix.length;
    ...
    public static int[][] Eleven(int[][] matrix) {
    ...
    public static int[][] Fiveteen(int[][] matrix) {
    ...
    public static int[][] Eighteen(int[][] matrix) {
        int rows = matrix.length;
        int cols = matrix[0].length;
